...
public class HexGridChunk : MonoBehaviour
{
    ...
    private void TriangulateConnection(HexDirection direction, HexCell cell, EdgeVertices e1)
    {
        ...
        {
            TriangulateEdgeStrip(e1, _weights1, cell.Index, e2, _weights2, neighbor.Index, hasRoad);
        }
    ...
    private void TriangulateEdgeStrip(EdgeVertices e1, Color w1, float index1, EdgeVertices e2, Color w2, float index2,
        bool hasRoad = false)
    {
    ...
    private void TriangulateWithoutRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        if (cell.HasRoads)
        {
            ...
            TriangulateRoad(center, Vector3.Lerp(center, e.V1, interpolators.x),
                Vector3.Lerp(center, e.V5, interpolators.y), e, cell.HasRoadThroughEdge(direction), cell.Index);
        }
    }
    ...
    private void TriangulateEstuary(EdgeVertices e1, EdgeVertices e2, bool incomingRiver, Vector3 indices)
    {
        ...
        Estuaries.AddQuadCellData(indices, _weights2, _weights1, _weights2, _weights1);
